...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  ...
  return [add, times, a + ' and ' + b + ' and ' + c + ' sum to ' + add + '.', 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + times + '.'];
}
...
function sumArray(testArray){ //eslint-disable-line
  var add = sum(sum(testArray[0], testArray[1])[0], testArray[2])[0];
  var say = testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + add + ' is their sum.';
  return [add, say];
}
